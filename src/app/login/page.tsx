...
export default function Login() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-black">  {/* Dark bg */}
            <Card className="w-[400px] bg-gray-900 border-gray-700">  {/* Dark card */}
                <CardHeader className="text-center">
                    <CardTitle className="text-2xl flex items-center justify-center gap-2 mb-2">
                        <span className="text-3xl">🖼️</span> Imagini
                    </CardTitle>
                ...
                <CardContent className="space-y-4">
                    <form onSubmit={handleSubmit}>
                        <div className="space-y-2">
                            ...
                            {error && <p className="text-red-500 text-sm text-center">{error}</p>}  {/* Red error */}
                        </div>
                        <Button type="submit" className="w-full bg-green-600 hover:bg-green-700">Sign In</Button>
                    </form>
                    <Button variant="link" className="w-full text-green-500 hover:text-green-400 justify-start p-0 h-auto">
                        Forgot Password?
                    </Button>
                </CardContent>
            </Card>
